function [ciu, Q] = consensus_adapted_louvain(d,tau,reps)
% This is a copy of the BCT's consensus_und.m function, with the
% modification that we additionally return the mean Q value over all
% repititions of the final partition. 
