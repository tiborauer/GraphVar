...
'Clustering coefficient global - positive weights - UND','clusterMean_bu_pos',1, ...
'Clustering coefficient: <br>The clustering coefficient is the fraction of triangles around a node and is equivalent to the fraction of node’s neighbors that are neighbors of each other. <br>Mean value above all brain regions';

'Clustering coefficient global - negative weights - UND','clusterMean_bu_neg',1, ...
'Clustering coefficient: <br>The clustering coefficient is the fraction of triangles around a node and is equivalent to the fraction of node’s neighbors that are neighbors of each other. <br>Mean value above all brain regions';
...
'Characteristic path global - positive weights - UND/DIR','charpath_B_pos',1, ...
'Characteristic path length:<br>The characteristic path length is the average shortest path length in the network.';

'Characteristic path global - negative weights - UND/DIR','charpath_B_neg',1, ...
'Characteristic path length:<br>The characteristic path length is the average shortest path length in the network.';
...
'Cluster coefficient global positive weight - UND SIGN','clustering_coef_wu_sign_pos',1, ...
'Clustering coefficient: <br>The clustering coefficient is the fraction of triangles around a node and is equivalent to the fraction of node’s neighbors that are neighbors of each other.  <br>Mean value above all brain regions.';

'Cluster coefficient global negative weight - UND SIGN','clustering_coef_wu_sign_neg',1, ...
'Clustering coefficient: <br>The clustering coefficient is the fraction of triangles around a node and is equivalent to the fraction of node’s neighbors that are neighbors of each other.  <br>Mean value above all brain regions.';

'Cluster coefficient global (normalized input weight) - UND','clusterMean_wu_normalized',1, ...
'Clustering coefficient: <br>The clustering coefficient is the fraction of triangles around a node and is equivalent to the fraction of node’s neighbors that are neighbors of each other.  <br>Mean value above all brain regions.';

'Cluster coefficient global - positive weight (normalized input weight) - UND','clusterMean_wu_normalized_pos',1, ...
'Clustering coefficient: <br>The clustering coefficient is the fraction of triangles around a node and is equivalent to the fraction of node’s neighbors that are neighbors of each other.  <br>Mean value above all brain regions.';

'Cluster coefficient global - negative weight (normalized input weight) - UND','clusterMean_wu_normalized_neg',1, ...
'Clustering coefficient: <br>The clustering coefficient is the fraction of triangles around a node and is equivalent to the fraction of node’s neighbors that are neighbors of each other.  <br>Mean value above all brain regions.';
...
'Characteristic path global - positive weight (normalized input weight) - UND/DIR','charpath_W__normalized_pos',1, ...
'Characteristic path length:<br>The characteristic path length is the average shortest path length in the network.';

'Characteristic path global - negative weight (normalized input weight) - UND/DIR','charpath_W__normalized_neg',1, ...
'Characteristic path length:<br>The characteristic path length is the average shortest path length in the network.';
