...
function [res,allTasks,del,groups_label,idx_group_1,idx_group_2] = GraphVar_calc_GroupCommunity(handles,filesType,group_type,selField,varargin)
global running
...
if dialogData.newInterimResults
    ...
    mkdir([workspacePath filesep 'results' filesep num2str(InterimResultsID) filesep 'GroupCommunity']);      
